...
(function() {
  ...
  GaugePointer = (function(superClass) {
    ...
    GaugePointer.prototype.render = function() {
      ...
      angle = this.gauge.getAngle.call(this, this.displayedValue) + this.options.angle_offset / _radToDeg;
  ...
  Gauge = (function(superClass) {
    ...
    Gauge.prototype.set = function(value) {
      ...
      for (m = 0, len = value.length; m < len; m++) {
        ...
        this.gp[i].value = val;
        if (i == 1){
            this.gp[i].setOptions({color: this.gp[i].options.color2,});
        }
